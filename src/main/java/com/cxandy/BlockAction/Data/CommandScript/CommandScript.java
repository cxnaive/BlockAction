        ...
        try {
            ...
            if (amountidx != Undefined) {
                ...
                if (now.ExcuteAmountLimit <= 0)
                    return new Pair<>("@Amount can not be lower than 1.", Optional.empty());
            }
            if (cooldownidx != Undefined) {
                ...
                if (now.CooldownSeconds <= 0) return new Pair<>("@Cooldown can not lower than 1.", Optional.empty());
            }
            if (valueidx != Undefined) {
                ...
                if (now.RequiredValue <= 0) return new Pair<>("@Value can not be lower than 1.", Optional.empty());
            }
            if (handitemidx != Undefined) {
                ...
                if (now.RequiredHandItemAmount <= 0)
                    return new Pair<>("@Hand: item's limit amount can not be lower than 1.", Optional.empty());
            }
            ...
            if (itemidx != Undefined) {
                ...
                for (String cur : contents) {
                    ...
                    if (nowli <= 0)
                        return new Pair<>("@Item: item's limit amount can not lower than 1.", Optional.empty());
