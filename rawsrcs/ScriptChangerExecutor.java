...
public class ScriptChangerExecutor implements CommandExecutor {
    @Override
    public CommandResult execute(CommandSource source, CommandContext args) throws CommandException {
        if(source instanceof Player){
            Player player = (Player) source;
            String content = args.<String>getOne(Text.of("content")).get();
            Pair<String,Optional<CommandScript>> result = CommandScript.ConvertStringFromSender(content,CommandScript.ChangeModeToken,player);
            ...
            if(scriptOptional.isPresent()){
                ...
                player.sendMessage(Text.builder("Successfully change mode to ")
                        ...
                        .append(Text.builder("ChangeMode\n")
                        ...
                        .append(Text.builder("Left click a block to override/add its last script's contents!")
                                .build())
                        .build());
            }
            else{
            ...
            source.sendMessage(Text.builder("Change command can only be used by players!").color(TextColors.RED).style(TextStyles.BOLD).build());
        }
